...
const faqs = [
  ...
  },
  {
    ...
    answer: "Yes, at any time. It's your system running for your business, and you're never locked into something you can't step back from.",
  },
  {
        ...
        <Container>
          <div className="max-w-2xl">
            ...
            <p className="mt-6 text-text-muted">
              ...
              enquiries come in at all hours, through multiple channels including phone, website,
              WhatsApp, and social media, and no single busy owner or small team can realistically

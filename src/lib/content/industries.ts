  ...
  },
  {
    ...
    scenarios: [
      ...
      },
      {
        ...
        description: "Clients due a repeat visit — colour top-up, maintenance treatment — can be prompted to rebook automatically rather than relying on them to remember.",
      },
    ],
    relatedServices: ["bookings-and-scheduling", "follow-ups-and-nurture", "enquiries-and-leads"],
    faqs: [
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "It works for both. For walk-in-heavy operations, the bigger win is often the missed-call and enquiry handling rather than the booking calendar itself — we'll recommend the right starting point during scoping.",
      },
    ],
  },
  {
